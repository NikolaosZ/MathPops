...
public class PrimesActivity extends Activity implements OnClickListener {
		
		/** Generate range of possible balloon values*/
		int [] balloonValues = generateValues();
		...
		TextView instruction, text1, text2, text3, text4, text5;
		...
		public void onCreate(Bundle savedInstanceState) {
			...
			instruction.setText("Pop Primes!");
		...
		public void onClick(View v) {
			...
			case R.id.value1: {
				...
				if (Calculations.isPrime(b1.getValue()))
				{
			...
			case R.id.value2: {
				...
				if (Calculations.isPrime(b2.getValue()))
				{
					feedbackmsg.setText("Correct!");
					score += inc;
					dispScore.setText(Integer.toString(score));
			...
			case R.id.value3: {
				...
				if (Calculations.isPrime(b3.getValue()))
				{
					feedbackmsg.setText("Correct!");
					score += inc;
					dispScore.setText(Integer.toString(score));
			...
			case R.id.value4: {
				...
				if (Calculations.isPrime(b4.getValue()))
				{
					feedbackmsg.setText("Correct!");
					score += inc;
					dispScore.setText(Integer.toString(score));
			...
			case R.id.value5: {
				...
				if (Calculations.isPrime(b5.getValue()))
				{
					feedbackmsg.setText("Correct!");
					score += inc;
					dispScore.setText(Integer.toString(score));
			...
			case R.id.button1: {
				...
				//Reset value of feedback messsage
				feedbackmsg.setText("");
		...
		public static int[] generateValues(){
			...
			int val1 = Calculations.generatePrime();
			int val2 = Calculations.generatePrime();
			int val3 = Calculations.generatePrime();
			int val4 = Calculations.generatePrime();
			int val5 = Calculations.generatePrime();
			int val6 = RNG.randInt(20, 300);
			int val7 = RNG.randInt(20, 300);
			int val8 = RNG.randInt(20, 300);
			int val9 = RNG.randInt(20, 300);
			int val10 = RNG.randInt(20, 300);
